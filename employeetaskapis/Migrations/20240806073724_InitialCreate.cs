    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Albert@example.com", "Albert Joe" },
                    { 2, "John@example.com", "John Snow" },
                    { 3, "Mike@example.com", "Mike James" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, "admin", "Admin", "admin" },
                    { 2, 2, "manager", "Manager", "manager" },
                    { 3, 1, "employee", "Employee", "employee" }
                });

            migrationBuilder.InsertData(
                table: "Documents",
                columns: new[] { "DocumentId", "FileContent", "FileName", "TaskId" },
                values: new object[] { 1, new byte[] { 72, 101, 108, 108, 111, 44, 32, 116, 104, 105, 115, 32, 105, 115, 32, 116, 104, 101, 32, 99, 111, 110, 116, 101, 110, 116, 32, 116, 111, 32, 116, 104, 105, 115, 32, 100, 111, 99, 117, 109, 101, 110, 116, 46 }, "Document1.txt", 1 });
